        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Amount of this installment",
                        max_digits=10,
                        verbose_name="Amount"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="scheduled",
                        help_text="Current status of this installment",
                        max_length=20,
                        verbose_name="Status"
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Date and time when this installment was paid",
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="PostFinance token ID for charging this installment",
                        max_length=255,
                        null=True,
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Date and time when grace period ends for failed installments",
                        null=True,
                        verbose_name="Grace Period Ends"
                    ),
                ),
                (
                    "num_installments",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["due_date"],
                        name="pretix_postf_due_dat_6a1b2e_idx"
                    ),
                    models.Index(
                        fields=["status"],
                        name="pretix_postf_status_7c8f9a_idx"
                    ),
                    models.Index(
                        fields=["order", "status"],
                        name="pretix_postf_order_i_8b2c1d_idx"
                    ),
                ],
            },
        ),
